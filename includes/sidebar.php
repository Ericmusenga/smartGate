...
<aside class="sidebar">
    <nav class="sidebar-menu">
        ...
        <?php elseif ($user_type === 'security'): ?>
            <div class="menu-section">
                <h3>Security</h3>
                <a href="/Capstone_project/pages/dashboard_security.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) === 'dashboard_security.php' ? 'active' : ''; ?>">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
                <a href="/Capstone_project/pages/logs.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) === 'logs.php' ? 'active' : ''; ?>">
                    <i class="fas fa-clipboard-list"></i> Entry/Exit Logs
        ...
        <?php else: ?>
            <div class="menu-section">
                ...
                <a href="/Capstone_project/pages/my_logs.php" class="menu-item <?php echo basename($_SERVER['PHP_SELF']) === 'my_logs.php' ? 'active' : ''; ?>">
                    <i class="fas fa-clipboard-list"></i> My Entry/Exit Logs
                </a>
