...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO computer_lending (lender_id, borrower_id, borrower_reg_number, notes, lend_date, status) VALUES (?, ?, ?, ?, NOW(), 'pending')";
    
    $stmt = $conn->prepare($insert_query);
    $stmt->bind_param("iiss", $lender_id, $reg_number, $borrower['registration_number'], $notes);
